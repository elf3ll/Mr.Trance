...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		portraitRight = new FlxSprite(80, 55);
		...
		portraitGirl = new FlxSprite(80, 55);
		portraitGirl.frames = Paths.getSparrowAtlas('weeb/gfPortrait');
		portraitGirl.animation.addByPrefix('enter', 'GF portrait enter', 24, false);
		portraitGirl.updateHitbox();
		portraitGirl.scrollFactor.set();
		add(portraitGirl);
		portraitGirl.visible = false;
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf':
				...
				portraitRight.visible = false;
				box.flipX = false;
				if (!portraitGirl.visible)
				{
					portraitGirl.visible = true;
					portraitGirl.animation.play('enter');
				}
		}
	}
