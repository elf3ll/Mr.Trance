...
class MainMenuState extends MusicBeatState
{
	...
	public static var gameVer:String = "0.0.1.0";
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					fancyOpenURL("https://www.youtube.com/watch?v=c_ZqkwrJtPU");
				}
				else
				{
	...
	function goToState()
	{
		...
		{
			case 'story mode':
				FlxG.switchState(new VideoState('assets/videos/cinematic.webm', new StoryMenuState()));
				trace("Story Menu Selected");
			case 'freeplay':
				FlxG.switchState(new VideoState('assets/videos/cinematic.webm', new FreeplayState()));

				trace("Freeplay Menu Selected");

			case 'options':
				FlxG.switchState(new VideoState('assets/videos/cinematic.webm', new OptionsDirect()));
		}
	}
