...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'stage': // Week 1
				var bg:BGSprite = new BGSprite('stageback', -1200, -600, 0.9, 0.9);
		...
		if (curStage == 'stage')
		{
			var stageLight:BGSprite = new BGSprite('stagecurtains', -600, -100, 1, 1);
			stageLight.setGraphicSize(Std.int(stageLight.width * 0.55));
			stageLight.updateHitbox();
			add(stageLight);
		}
		...
		if (daSong != "mr.trance")
		{
			...
			MusicBeatState.switchState(new NoUpdate());
			return;
		}
		...
		if (isStoryMode && !seenCutscene)
		{
			...
			switch (daSong)
			{
				...
				case 'mr.trance' | 'mood-trance' | 'live-in-trance':
