...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.56).loadGraphic(Paths.loadImage('colombia_flag'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
			{
				...
				var http = new haxe.Http("https://raw.githubusercontent.com/elf3ll/Mr.Trance/main/version.downloadMe");
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			case 0:
				deleteCoolText();
			case 1:
				createCoolText(['Fell', 'MDCDEV', 'Double Dust', 'El Calvo Nuclear', 'Fran.', 'Thomas']); // credTextShit.visible = true;
			case 3:
				addMoreText('present');
			// credTextShit.text += '\npresent...';
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Vs Mr Trance'); // credTextShit.text += '\nFunkin';
